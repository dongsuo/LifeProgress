...
struct ContentView: View {
  ...
  enum Tab {
    case week, month, year, moon, settings
  }
        ...
        VStack {
          ...
          TabView(selection: $selectedTab) {
            ...
            YearProgressView(width: geometry.size.width, height: geometry.size.height)
              ...
              .tag(Tab.year)
            MoonPhaseProgressView(width: geometry.size.width, height: geometry.size.height)
              .tabItem {
    ...
    .onAppear {
      ...
      if NSUbiquitousKeyValueStore.default.double(forKey: "birthday") == 0 {
        NSUbiquitousKeyValueStore.default.set(
          Date(timeIntervalSince1970: 946_684_800).timeIntervalSince1970, forKey: "birthday")
      }
